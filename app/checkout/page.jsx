...
export default function CheckoutPage() {
  ...
  const shippingCharge = isFreeStandard ? 0 : applicableShippingRate;
      ...
      <div className="max-w-xl mx-auto py-16 px-4 text-center">
        <div className="bg-white p-8 sm:p-12 rounded-3xl border border-slate-200 shadow-xl space-y-6">
          ...
          <p className="text-xs text-slate-500">
            A confirmation has been prepared for WhatsApp. If it didn't open automatically, please reach us on WhatsApp at{" "}
